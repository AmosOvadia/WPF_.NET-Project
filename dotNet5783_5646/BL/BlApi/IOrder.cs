...
{
    public IEnumerable<OrderForList?> GetOrders(Func<DO.Order?, bool>? filter = null); // The function returns a list of all orders
    ...
    public OrderTracking Order_tracking(int Id);  // The function returns the tracking of the order
